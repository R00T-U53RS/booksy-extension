...
const Sidebar = ({ setProfile }: { setProfile: (profile: Profile) => void }) => {
    ...
    <div className="flex flex-col items-center w-24 bg-slate-950">
      ...
      <div className="flex items-center justify-center py-6">
        <Avatar className="w-12 h-12">
          ...
          <AvatarFallback className="bg-blue-500 text-white text-sm font-semibold">B</AvatarFallback>
        </Avatar>
      </div>
      ...
      <div className="flex flex-col space-y-4 flex-1">
        {profileItems.map((item) => (
          <div
            ...
            `}
          >
            <div className={`flex flex-col items-center justify-center rounded-lg text-sm font-bold ${activeSection === item.id ? 'text-white' : 'text-slate-400'}`}>
